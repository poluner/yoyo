 ...
 */
_u32 VodNewGz_uncompress_file(char * filename, char * newname);
 ...
 * @return: 0-SUCCESS else-FAIL
 */
_int32 VodNewGz_decode_buffer(_u8* buffer_in, _u32 buffer_in_len, _u8** buffer_out, _u32* buffer_out_len,  _u32* decode_len);
 ...
 * @return: 0-SUCCESS else-FAIL
 */
_int32 VodNewGz_encode_buffer(_u8* buffer_in, _u32 buffer_in_len, _u8* buffer_out, _u32 buffer_out_len, _u32* encode_len);
...
_int32 VodNewGz_zip_data( const _u8 * src, _u32 src_len,_u8 * des, _u32 * des_len);
...
_int32 VodNewGz_unzip_data( const _u8 * src, _u32 src_len,_u8 * des, _u32 * des_len);

//////////////////////////////////
//对整个文件进行gzip解压，并用解压后的文件替换解压前的文件
//file_name:待解压文件全名
_int32 VodNewGz_unzip_file(const char * file_name);
